...
class TranslationsAboutPageEn {
  ...
  /// en: 'About Meerkat'
  String get title => 'About Meerkat';

  List<String> get description => [
    'Meerkat is a free, open-source app that allows you to securely share files and messages with nearby devices over your local network without needing an internet connection.',
    'This app is available on Android, iOS, macOS, Windows and Linux. Meerkat is derived from LocalSend with enhanced themes and branding.',
  ];
...
class TranslationsDonationPageEn {
  ...
  /// en: 'Meerkat is free and open-source. If you like the app, consider supporting the original LocalSend project or contribute to Meerkat's development!'
  String get info =>
      'Meerkat is free and open-source. If you like the app, consider supporting the original LocalSend project or contribute to Meerkat\'s development!';
...
class TranslationsSettingsTabGeneralEn {
  ...
  /// en: 'Show Meerkat in context menu'
  String get showInContextMenu => 'Show Meerkat in context menu';
